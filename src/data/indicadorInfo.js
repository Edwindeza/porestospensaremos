export const TITLES = {
  ...
  '5': 'I5 — Historial asociado #PorEstosNo (cantidad 0 a 30)',
...
export const TEXTO_INFO_I5 = 'Mide cuántos candidatos de la lista al Senado (de 30) tienen participación pasada en partidos de #PorEstosNo. Es una cantidad de 0 a 30 por lista. Un valor más alto indica más candidatos con ese historial; puedes descartar partidos por encima de un umbral que elijas.'
